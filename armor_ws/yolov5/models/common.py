...
def forward_fuse(self, x):
    # 显式转换为整数padding
    padding = (self.conv.padding[0], self.conv.padding[1]) if isinstance(self.conv.padding, tuple) else self.conv.padding
    return self.act(F.conv2d(x, self.conv.weight, self.conv.bias, self.conv.stride,
